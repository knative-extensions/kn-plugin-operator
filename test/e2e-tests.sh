...
echo ">> Configure Knative Serving with the Kourier ingress"
./kn-operator enable ingress --kourier -n ${SERVING_NAMESPACE} || fail_test "Failed to enable Kourier for Knative Serving"
