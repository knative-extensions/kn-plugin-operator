...
// TestEventingHAConfiguration verifies whether the operator plugin can configure the number of replicas for Knative Eventing
func TestEventingHAConfiguration(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		t.Run(tt.name, func(t *testing.T) {
			resources.VerifyKnativeEventingHAs(t, clients.Operator.KnativeEventings(resources.EventingOperatorNamespace),
				tt.expectedHAFlags)
		})
	}
}
