//go:build eventingimagedelete
// +build eventingimagedelete
...
// TestEventingImageDelete verifies whether the operator plugin can delete the image of the deployment for Knative Eventing
func TestEventingImageDelete(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		t.Run(tt.name, func(t *testing.T) {
			resources.VerifyKnativeEventingImagesDelete(t, clients.Operator.KnativeEventings(resources.EventingOperatorNamespace),
