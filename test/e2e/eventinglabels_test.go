//go:build eventinglabelconfig
// +build eventinglabelconfig
...
// TestEventingLabelConfiguration verifies whether the operator plugin can configure the labels for Knative Eventing
func TestEventingLabelConfiguration(t *testing.T) {
