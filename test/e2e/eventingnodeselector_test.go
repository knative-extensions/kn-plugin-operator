//go:build eventingnodeselectorconfig
// +build eventingnodeselectorconfig
...
// TestEventingNodeSelectorConfiguration verifies whether the operator plugin can configure the NodeSelectors for Knative Eventing
func TestEventingNodeSelectorConfiguration(t *testing.T) {
