//go:build servingannotationconfig
// +build servingannotationconfig
...
// TestServingAnnotationConfiguration verifies whether the operator plugin can configure the annotation for Knative Serving
func TestServingAnnotationConfiguration(t *testing.T) {
