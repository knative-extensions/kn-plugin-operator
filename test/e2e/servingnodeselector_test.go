//go:build servingnodeselectorconfig
// +build servingnodeselectorconfig
...
// TestServingNodeSelectorConfiguration verifies whether the operator plugin can configure the NodeSelectors for Knative Serving
func TestServingNodeSelectorConfiguration(t *testing.T) {
