//go:build servingservicelabelconfig
// +build servingservicelabelconfig
...
// TestServingServiceLabelConfiguration verifies whether the operator plugin can configure the labels for the service in Knative Serving
func TestServingServiceLabelConfiguration(t *testing.T) {
